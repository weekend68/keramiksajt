...
export default async function ProductPage({ params }: ProductPageProps) {
  ...
  return (
    <div className="min-h-screen bg-warm-white">
      {/* Header */}
      <header className="bg-white border-b border-warm-beige">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <Link href="/" className="text-warm-gray hover:text-warm-black text-sm">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
          <div className="grid grid-cols-1 md:grid-cols-5 gap-0">
            ...
            <div className="md:col-span-3 aspect-square md:aspect-auto relative bg-warm-beige">
              {product.image ? (
                <Image
                  src={product.image}
                  alt={product.name}
            ...
            <div className="md:col-span-2 p-8">
              <div className="mb-6">
                ...
                <h1 className="text-3xl font-serif font-bold text-warm-black mt-2">
                  {product.name}
                </h1>
              ...
              <div className="border-t border-warm-beige pt-6 mb-8">
              ...
              {/* Swish Payment Info */}
              <div className="bg-warm-amber-50 border-2 border-warm-amber-600 rounded-2xl p-6">
                <h2 className="text-xl font-serif font-semibold text-warm-black mb-2">
                  Köp med Swish
                </h2>

                {/* Trust Indicators */}
                <div className="flex gap-4 mb-4 text-sm text-warm-gray">
                  <span>✓ Handgjord</span>
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-2">
                      <code className="flex-1 bg-white px-4 py-3 rounded border border-warm-amber-600 text-lg font-mono">
                        {swishNumber}
                      </code>
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-2">
                      <code className="flex-1 bg-white px-4 py-3 rounded border border-warm-amber-600 text-lg font-mono font-bold">
                  ...
                  <div>
                    ...
                    <div className="bg-white px-4 py-3 rounded border border-warm-amber-600 text-lg font-semibold">
                      {product.price} kr
                    </div>
                  </div>
                </div>

                <div className="mt-6 text-sm text-warm-gray bg-white p-4 rounded-lg">
