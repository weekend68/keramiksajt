                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-2">
                      <code className="flex-1 bg-white px-4 py-3 rounded border border-stone-300 text-lg font-mono">
                        {swishNumber}
                      </code>
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-2">
                      <code className="flex-1 bg-white px-4 py-3 rounded border border-stone-300 text-lg font-mono font-bold">
                  ...
                  <div>
                    ...
                    <div className="bg-white px-4 py-3 rounded border border-stone-300 text-lg font-semibold">
                      {product.price} kr
                    </div>
                  </div>
                </div>

                <div className="mt-6 text-sm text-stone-600 bg-white p-4 rounded">
